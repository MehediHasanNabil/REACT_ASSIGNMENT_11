                    ...
                    <Col md={6} className="p-3">
                        <Form>
                            <Form.Group controlId="formBasicEmail">
                                <Form.Control className="p-4" type="email" placeholder="Your email address" required />
                            </Form.Group>
                            <Form.Group controlId="formBasicPassword">
                                <Form.Control className="p-4" type="text" placeholder="Your name / company’s name" required />
                            </Form.Group>
                            <Form.Group controlId="formBasicPassword">
                                <Form.Control className="p-4" as="textarea" rows={3} placeholder="Your message" required />
                            </Form.Group>
